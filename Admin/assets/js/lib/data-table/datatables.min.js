...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"הבא",sPrevious:"הקודם"},sEmptyTable:"אין רשומות בטבלה",sInfo:"Showing _START_ to _END_ of _TOTAL_ entries",sInfoEmpty:"מראה 0  מתוך 0 של 0 רשומות",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"הראה _MENU_ רשומות",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"חפש:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"לא נמצאה התאמה"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
